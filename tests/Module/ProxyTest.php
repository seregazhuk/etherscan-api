...
final class ProxyTest extends TestCase
{
    ...
    public function it_retrieves_transaction_block_by_number(): void
    {
        ...
        $this->httpClientMock
            ...
            ->method('sendRequest')
            ->with($this->callback(function (RequestInterface $request): bool {
                $this->assertSame('chainid=1&module=proxy&action=eth_getBlockByNumber&apikey=apiKey&tag=0x10d4f&boolean=0', $request->getUri()->getQuery());
        ...
        $this->assertSame('', $result->logsBloom);
        ...
        $this->assertSame('0x40330c87750aa1ba1908a787b9a42d0828e53d73100ef61ae8a4d925329587b5', $result->transactions[0]);
        $this->assertSame('0x6fa2208790f1154b81fc805dd7565679d8a8cc26112812ba1767e1af44c35dd4', $result->transactions[1]);;
        $this->assertSame('0x9e8622c7bf742bdeaf96c700c07151c1203edaf17a38ea8315b658c2e6d873cd', $result->uncles[0]);
        $this->assertSame('0xaceb14fcf363e67d6cdcec0d7808091b764b4428f5fd7e25fb18d222898ef779', $result->transactionsRoot);
    }
    ...
    public function it_retrieves_transaction_count_for_block(): void
    {
        ...
        $this->httpClientMock
            ...
            ->method('sendRequest')
            ->with($this->callback(function (RequestInterface $request): bool {
                $this->assertSame('chainid=1&module=proxy&action=eth_getBlockTransactionCountByNumber&apikey=apiKey&tag=0x10FB78', $request->getUri()->getQuery());
    ...
    public function it_retrieves_transaction_receipt(): void
    {
        ...
        $this->assertSame('', $result->logsBloom);
        $this->assertSame('0x1', $result->status);
        $this->assertSame('0xdac17f958d2ee523a2206206994597c13d831ec7', $result->to);
        $this->assertSame('0xadb8aec59e80db99811ac4a0235efa3e45da32928bcff557998552250fa672eb', $result->transactionHash);
        ...
        $this->assertSame('0xadb8aec59e80db99811ac4a0235efa3e45da32928bcff557998552250fa672eb', $result->logs[0]->transactionHash);
        $this->assertSame('0x122', $result->logs[0]->transactionIndex);
        $this->assertSame('0x07c17710dbb7514e92341c9f83b4aab700c5dba7c4fb98caadd7926a32e47799', $result->logs[0]->blockHash);
        $this->assertSame('0xdb', $result->logs[0]->logIndex);
        $this->assertFalse($result->logs[0]->removed);
        $this->assertSame('0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef', $result->logs[0]->topics[0]);
        $this->assertSame('0x000000000000000000000000292f04a44506c2fd49bac032e1ca148c35a478c8', $result->logs[0]->topics[1]);
        $this->assertSame('0x000000000000000000000000ab6960a6511ff18ed8b8c012cb91c7f637947fc0', $result->logs[0]->topics[2]);
    }
}
